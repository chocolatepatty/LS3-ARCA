 ...
 */
public class DR_XNOR extends Gate {
	...
	public DR_XNOR() {
		...
		getPin(4).moveTo(getX() + getWidth() + 10, getY() + 30);
		getPin(5).moveTo(getX() + getWidth() + 10, getY() + 40);
	...
	public void simulate() {
		...
		boolean newLevel1 = (inp1_0 && inp2_1) || (inp1_1 && inp2_0);
		boolean newLevel2 = (inp1_1 && inp2_1) || (inp1_0 && inp2_0);
	...
	protected void drawANSI(Graphics2D g2) {
		...
		p.curveTo(xl2 + 10, yu + 10, xl2 + 10, yb - 10, xl2, yb);
		...
		Ellipse2D n = new Ellipse2D.Double();
		n.setFrame(getX() + getWidth() - 10, getY() + getHeight() / 2 - 7, 15, 15);
	...
	public void loadLanguage() {
		I18N.addGate(I18N.ALL, type, I18N.TITLE, "DR_XNOR");
		I18N.addGate(I18N.ALL, type, I18N.DESCRIPTION, "Dual rail XNOR Gate");
	}
