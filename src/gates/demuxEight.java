 ...
 */
public class demuxEight extends Gate {
	...
	public demuxEight() {
		...
		getPin(inpNo + 0).label = "A4_1";
		getPin(inpNo + 1).label = "A4_0";
		getPin(inpNo + 2).label = "A3_1";
		getPin(inpNo + 3).label = "A3_0";
		getPin(inpNo + 4).label = "A2_1";
		getPin(inpNo + 5).label = "A2_0";
		getPin(inpNo + 6).label = "A1_1";
		getPin(inpNo + 7).label = "A1_0";
		
		getPin(inpNo + 8).label = "B4_1";
		getPin(inpNo + 9).label = "B4_0";
		getPin(inpNo + 10).label = "B3_1";
		getPin(inpNo + 11).label = "B3_0";
		getPin(inpNo + 12).label = "B2_1";
		getPin(inpNo + 13).label = "B2_0";
		getPin(inpNo + 14).label = "B1_1";
		getPin(inpNo + 15).label = "B1_0";
	...
	public void simulate() {
		...
		if (!getPin(8).getLevel() && !getPin(9).getLevel()) {
	...
	public void loadLanguage() {
		I18N.addGate(I18N.ALL, type, I18N.TITLE, "demuxEight");
		I18N.addGate(I18N.ALL, type, I18N.DESCRIPTION, "4-bit 2-way demultiplexer");
	}
}