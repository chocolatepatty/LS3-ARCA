			...
			for (Gate g : f.getGates()) {
				...
				if (g.type == "and" || g.type == "or" || g.type == "xor" || g.type == "nand" || g.type == "nor" || g.type == "xnor" || g.type == "not") {
					...
					try {
						...
						vWriter.write("	  " + vName + " (");
						vWriter.write(System.lineSeparator());
						if (vModule == "celement" || vModule == "celementnb" || vModule == "arbuffer" || vModule == "arbuffer2" || vModule == "arbuffer4" || vModule == "arbuffer8" || vModule == "arbuffer16" || vModule == "cpl" || vModule == "dr_and" || vModule == "dr_or" || vModule == "dr_xor" || vModule == "dr_nand" || vModule == "dr_nor" || vModule == "dr_xnor") {
							vWriter.write("	  .reset(reset),");
							vWriter.write(System.lineSeparator());
							vWriter.write("	  .master(master),");
							vWriter.write(System.lineSeparator());
						}
					} 
					catch (IOException e) {
